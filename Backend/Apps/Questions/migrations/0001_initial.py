# Generated by Django 3.2.9 on 2022-01-07 00:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('uuid', models.CharField(max_length=50)),
                ('name', models.CharField(choices=[('physicsAdv', 'physicsAdv'), ('mathsAdv', 'mathsAdv'), ('chemAdv', 'chemAdv'), ('physicsMains', 'physicsMains'), ('mathsMains', 'mathsMains'), ('chemMains', 'chemMains'), ('physicsNeet', 'physicsNeet'), ('chemNeet', 'chemNeet'), ('bio', 'bio'), ('reasoningHard', 'reasoningHard'), ('reasoningEasy', 'reasoningEasy'), ('currentAffairsWorldEasy', 'currentAffairsWorldEasy'), ('currentAffairsWorldHard', 'currentAffairsWorldHard'), ('currentAffairsIndiaEasy', 'currentAffairsIndiaEasy'), ('currentAffairsIndiaHard', 'currentAffairsIndiaHard'), ('quantAptHard', 'quantAptHard'), ('quantAptEasy', 'quantAptEasy'), ('quantAptEasyHindi', 'quantAptEasyHindi'), ('englishLangAndComprehensionEasy', 'englishLangAndComprehensionEasy'), ('englishLangAndComprehensionHard', 'englishLangAndComprehensionHard'), ('basicComputer', 'basicComputer'), ('economyAndBanking', 'economyAndBanking'), ('geographyIndHard', 'geographyIndHard'), ('geographyIndEasy', 'geographyIndEasy'), ('geographyWorld', 'geographyWorld'), ('polityIndEasy', 'polityIndEasy'), ('polityIndHard', 'polityIndHard'), ('economyIndGen', 'economyIndGen'), ('economyIndBudgetAndSchemes', 'economyIndBudgetAndSchemes'), ('environmentAndEcologyEasy', 'environmentAndEcologyEasy'), ('environmentAndEcologyHard', 'environmentAndEcologyHard'), ('historyIndEasy', 'historyIndEasy'), ('historyIndHard', 'historyIndHard'), ('historyWorld', 'historyWorld'), ('InternationalRelationAndSecurity', 'InternationalRelationAndSecurity'), ('sciAndTechEasy', 'sciAndTechEasy'), ('sciAndTechHard', 'sciAndTechHard'), ('generalScience', 'generalScience'), ('geographyRajEasy', 'geographyRajEasy'), ('geographyRajHard', 'geographyRajHard'), ('historyRajEasy', 'historyRajEasy'), ('historyRajHard', 'historyRajHard'), ('artAndCultureRaj', 'artAndCultureRaj'), ('polityRajHard', 'polityRajHard'), ('polityRajEasy', 'polityRajEasy'), ('currentAffairsRajHard', 'currentAffairsRajHard'), ('currentAffairsRajEasy', 'currentAffairsRajEasy'), ('artAndCultureInd', 'artAndCultureInd'), ('economyRajHard', 'economyRajHard'), ('economyRajEasy', 'economyRajEasy'), ('constitutionAndGovernance', 'constitutionAndGovernance'), ('decisionMaking', 'decisionMaking'), ('ndaHistory', 'ndaHistory'), ('ndaMaths', 'ndaMaths'), ('cdsMaths', 'cdsMaths'), ('currentEvents', 'currentEvents'), ('dataAnalysisAndInterpretation', 'dataAnalysisAndInterpretation'), ('financialAwareness', 'financialAwareness'), ('financeAndAccounts', 'financeAndAccounts'), ('statistics', 'statistics'), ('childDevelopmentAndEdu', 'childDevelopmentAndEdu'), ('teachingApt', 'teachingApt'), ('hindi', 'hindi'), ('staticGK', 'staticGK'), ('sscMTSGK', 'sscMTSGK'), ('rpcGKRaj', 'rpcGKRaj'), ('sscMTSReasoning', 'sscMTSReasoning'), ('gdQuantApt', 'gdQuantApt'), ('iasMisc', 'iasMisc'), ('jeeMisc', 'jeeMisc'), ('jeeMainsMisc', 'jeeMainsMisc'), ('jeeAdvMisc', 'jeeAdvMisc'), ('neetMisc', 'neetMisc'), ('rasMisc', 'rasMisc'), ('ibpsPOSSCMisc', 'ibpsPOSSCMisc'), ('ndaMisc', 'ndaMisc'), ('cdsMisc', 'cdsMisc'), ('reet1Misc', 'reet1Misc'), ('patwariMisc', 'patwariMisc'), ('grade2ndScienceMisc', 'grade2ndScienceMisc'), ('sscMTSMisc', 'sscMTSMisc'), ('iasMiscHindi', 'iasMiscHindi'), ('rasMiscHindi', 'rasMiscHindi'), ('sscCGLMiscHindi', 'sscCGLMiscHindi'), ('currentAffairsWorldHardHindi', 'currentAffairsWorldHardHindi'), ('currentAffairsIndiaEasyHindi', 'currentAffairsIndiaEasyHindi'), ('currentAffairsIndiaHardHindi', 'currentAffairsIndiaHardHindi'), ('geographyIndEasyHindi', 'geographyIndEasyHindi'), ('geographyIndHardHindi', 'geographyIndHardHindi'), ('geographyWorldHindi', 'geographyWorldHindi'), ('polityIndEasyHindi', 'polityIndEasyHindi'), ('polityIndHardHindi', 'polityIndHardHindi'), ('economyIndGenHindi', 'economyIndGenHindi'), ('economyIndBudgetAndSchemesHindi', 'economyIndBudgetAndSchemesHindi'), ('environmentAndEcologyHardHindi', 'environmentAndEcologyHardHindi'), ('environmentAndEcologyEasyHindi', 'environmentAndEcologyEasyHindi'), ('historyIndEasyHindi', 'historyIndEasyHindi'), ('historyIndHardHindi', 'historyIndHardHindi'), ('historyWorldHindi', 'historyWorldHindi'), ('InternationalRelationAndSecurityHindi', 'InternationalRelationAndSecurityHindi'), ('sciAndTechHardHindi', 'sciAndTechHardHindi'), ('artAndCultureIndHindi', 'artAndCultureIndHindi'), ('constitutionAndGovernanceHindi', 'constitutionAndGovernanceHindi'), ('decisionMakingHindi', 'decisionMakingHindi'), ('currentAffairsWorldEasyHindi', 'currentAffairsWorldEasyHindi'), ('sciAndTechEasyHindi', 'sciAndTechEasyHindi'), ('geographyRajEasyHindi', 'geographyRajEasyHindi'), ('geographyRajHardHindi', 'geographyRajHardHindi'), ('historyRajHardHindi', 'historyRajHardHindi'), ('historyRajEasyHindi', 'historyRajEasyHindi'), ('artAndCultureRajHindi', 'artAndCultureRajHindi'), ('polityRajEasyHindi', 'polityRajEasyHindi'), ('polityRajHardHindi', 'polityRajHardHindi'), ('currentAffairsRajHardHindi', 'currentAffairsRajHardHindi'), ('currentAffairsRajEasyHindi', 'currentAffairsRajEasyHindi'), ('economyRajHardHindi', 'economyRajHardHindi'), ('economyRajEasyHindi', 'economyRajEasyHindi'), ('reasoningHardHindi', 'reasoningHardHindi'), ('reasoningEasyHindi', 'reasoningEasyHindi'), ('quantAptHardHindi', 'quantAptHardHindi'), ('ibpsClerkSSCMisc', 'ibpsClerkSSCMisc'), ('statisticsHindi', 'statisticsHindi'), ('bioHindi', 'bioHindi'), ('physicsHindi', 'physicsHindi'), ('chemHindi', 'chemHindi')], default='mathsAdv', max_length=100000)),
