    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mebershipEndDate', models.DateTimeField(blank=True, null=True)),
                ...
                ('premiumExams', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20, null=True), blank=True, default=list, null=True, size=None)),
                ('addedQuestionDate', models.DateField(blank=True, null=True)),
