    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('premiumExams', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(blank=True, max_length=20, null=True), default=list, null=True, size=None)),
