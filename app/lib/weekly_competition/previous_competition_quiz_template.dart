...
class PreviousCompetitionQuizTemplate extends StatefulWidget {
  ...
  @override
  createState() {
    return PreviousCompetitionQuizTemplateState();
  }
}

class PreviousCompetitionQuizTemplateState
    extends State<PreviousCompetitionQuizTemplate> {
  ...
  void initState() {
    ...
    for (var i = 0; i < n; i++) {
      sampleData.add(RadioModel(widget.options[i][2], alphabets[i],
          widget.options[i][0], widget.options[i][1]));
    }
  }
